      ...
      <div class="article-detail">
        <div class="article-content">
          <div class="markdown-body">
            ...
            <!-- 我叫王嘉炀 -->
            <p>
              hello，大家好。很高心躲在这里被你发现了！<!-- <a href="#">让我知道下你是如何找到我的>></a> -->
            </p>
            ...
            <p>
              一直以来，我都有一个博客梦。还记得这几年断断续续亲手敲代码搞过好几个博客，最后都觉得不是自己想要的，也没写过几篇文章就放弃了。
            </p>
            <p>
              曾经也想用现有的博客平台，比如csdn、掘金、segmentfault等，但是总觉得牵制于人，非常不习惯，最后又是一度放弃了。
            </p>
            <p>
              再后来就随便找了个云笔记写写，比如为知笔记（支持linux、mac、windows），也还不错，记录了很多学习笔记，可更多是直接复制黏贴别人的知识点。
            </p>
            <p>
              <!-- 最近可能是学习比较认真吧，遇到的问题、碰到的坑实在太多；-->可总觉得想做点什么，最后想想，还是自己搞个在线博客吧，说不准可以帮助到谁谁谁呢。
            </p>

            <h2 id="articleHeader1">联系我</h2>
            <p>
              我是相当的宅，不擅长社交。。。微博基本没用过，qq、微信也很少更新。所以大家尽量还是给我邮件吧，我定会认真阅读你的来信！当然，最佳方式还是直接在本博客留言吧，<a
                href="/message"
                >留言板</a
              >。
            </p>
            <ul>
              <li>
                邮箱：<a href="mailto:346461062@qq.com">346461062@qq.com</a>
              </li>
              <li>GitHub：<a href="https://github.com/tulies">@tulies</a></li>
              <li>
                微博：<a href="https://weibo.com/u/6341197258">@王嘉炀Tulies</a>
              </li>
            </ul>
